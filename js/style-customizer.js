...
jQuery(document).ready(function ($) {
  ...
  if (!$.cookie("customizer_mode")) {
    ...
    if (customizer_mode == "boxed-layout") {
      ...
      $("body").addClass(customizer_mode);
      $("body").removeClass(
        "boxed-layout pattern-0 pattern-1 pattern-2 main-bg-1 main-bg-2"
      );
  ...
  $(".style-customizer .layoutstyle li.boxed-layout").on("click", function () {
    ...
    if ($.cookie("pattern")) {
      ...
      $("body").removeClass(
        "pattern-0 pattern-1 pattern-2 main-bg-1 main-bg-2"
      );
  ...
  $(".style-customizer .layoutstyle li.wide-layout").on("click", function () {
    ...
    $("body").removeClass(
      "boxed-layout pattern-0 pattern-1 main-bg-1 main-bg-2"
    );
    $("body").removeClass("");
    $(
      '.style-customizer .layoutstyle li[data-style="boxed-layout"]'
  ...
  $(".style-customizer .resetAll li a.button-reset").on("click", function () {
    ...
    $("body").removeClass(
      "reset pattern-0 pattern-1 pattern-2 main-bg-1 main-bg-2"
    );
    $(".style-customizer .patternChange .selected").removeClass("selected");
